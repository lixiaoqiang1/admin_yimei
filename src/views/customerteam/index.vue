<template>
    <div class="callvoice padding10">
        ...
        <div class="bj_white">
            ...
            <!-- 表格 -->
            <div class="table">
                <el-table stripe :data="userList.slice((page_index-1)*page_size,page_index*page_size)" style="width: 100%" @row-click="openDetails" @selection-change="handleSelectionChange">
